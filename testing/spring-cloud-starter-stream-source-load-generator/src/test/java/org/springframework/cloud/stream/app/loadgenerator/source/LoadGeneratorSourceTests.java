...
package org.springframework.cloud.stream.app.loadgenerator.source;
...
public class LoadGeneratorSourceTests {
	...
	@Autowired
	@Bindings(org.springframework.cloud.stream.app.loadgenerator.source.LoadGeneratorSourceConfiguration.class)
