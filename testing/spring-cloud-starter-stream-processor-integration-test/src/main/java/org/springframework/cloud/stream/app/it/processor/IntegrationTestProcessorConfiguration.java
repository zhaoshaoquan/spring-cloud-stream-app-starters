...
package org.springframework.cloud.stream.app.it.processor;

import static org.springframework.cloud.stream.app.it.processor.IntegrationTestProcessorProperties.FUNNY_CHARACTERS;
	...
	public void init() throws InterruptedException {
		...
		if (parameterThatMayNeedEscaping != null && !FUNNY_CHARACTERS.equals(parameterThatMayNeedEscaping)) {
			throw new IllegalArgumentException(String.format("Expected value to be equal to '%s', but was '%s'",
					FUNNY_CHARACTERS, parameterThatMayNeedEscaping));
		}
